 ...
 * @author AoiTuNa
 * @version 1.0
 * @see #validationRegisterRequest(RegisterRequestDto)
 * @see #isCreated(CreateRegisterRequestDto)
 */
public interface RegisterService {

  /**
   * 회원가입을 시도하는 유저가 입력한 값이 유효한지 판단하는 메서드 입니다!
   * @param registerRequestDto 유저가 입력한 값이 저장되는 domain 객체 입니다!
   ...
   * @param createRegisterRequestDto 유저가 유효한 값을 입력했을 때 Api 서버로 요청을 보내기위란 domain객체 입니다!
   */
